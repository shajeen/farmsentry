"""
Main application for the FarmSentry animal detection system (GPU Version).
"""
...
import src.config.config_gpu as config

def main():
    """
    Main function to run the animal detection system.
    """
    print("\n=== FarmSentry: Farmland Animal Alert System (GPU) ===")
    ...
    try:
        while True:
            ...
            cv2.imshow('FarmSentry - Animal Detection (GPU)', processed_frame)
